...
/*this main function acts as a sub-server, and gets connected to client when redirected by serverw24 based on the redirection rule, and performs almost the same except redirection*/
int main(void) {
